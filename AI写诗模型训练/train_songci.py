...
import dataHandler_songci
from model import PoetryModel
from utils import *
import pickle as p

data = dataHandler_songci.parseRawData()  # All if author=None
...
with open('wordDic_songci', 'wb') as f:  # 使用 open() 打开文件

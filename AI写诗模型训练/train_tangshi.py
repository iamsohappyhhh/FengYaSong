...
import dataHandler_tangshi
from model import PoetryModel
from utils import *
import pickle as p

data = dataHandler_tangshi.parseRawData()  # All if author=None
...
with open('wordDic_tangshi', 'wb') as f:  # 使用 open() 打开文件
    p.dump(word_to_ix, f)  # 将 word_to_ix 保存到文件中

...
import dataHandler_yuanqu
from model import PoetryModel
from utils import *
import pickle as p

data = dataHandler_yuanqu.parseRawData()  # All if author=None
...
with open('wordDic_yuanqu', 'wb') as f:  # 使用 open() 打开文件
